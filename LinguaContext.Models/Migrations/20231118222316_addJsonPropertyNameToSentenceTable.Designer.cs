...
namespace LinguaContext.Models.Migrations
{
    ...
    [Migration("20231118222316_addJsonPropertyNameToSentenceTable")]
    partial class addJsonPropertyNameToSentenceTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LinguaContext.Models.Sentence", b =>
                {
                    ...
                    b.Property<string>("AnswerTranslation")
                        ...
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)")
                        .HasAnnotation("Relational:JsonPropertyName", "answerTranslation");

                    b.Property<string>("ComplexityLevel")
                        .HasColumnType("text")
                        .HasAnnotation("Relational:JsonPropertyName", "complexityLevel");

                    b.Property<string>("FormattedPhrase")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasAnnotation("Relational:JsonPropertyName", "formattedSentence");

                    b.Property<string>("Phrase")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasAnnotation("Relational:JsonPropertyName", "sentence");

                    b.Property<string>("Translation")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
                        .HasAnnotation("Relational:JsonPropertyName", "translation");
